## Helper functions useful for when projecting annotations from reference --> query, then confirming whether these annotations are accurate
...
my_project_seurat<- function(reference_seurat, query_seurat, reduction="pcaproject",
                             reference_annotation, prediction_colNames=NULL, k.weight=50){
