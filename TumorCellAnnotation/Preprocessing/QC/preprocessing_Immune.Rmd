...
working_dir<- paste0(base_dir, 
                     ...
                     "TumorCellAnnotation/Preprocessing/QC/")
...
cm_files = list.files(path = data_dir, pattern="cm_tpm*")
  ...
  ## Remove new samples- BT1873 and BT1857
  cm_files<- cm_files[grep(paste(c("BT1873", "BT1857"), collapse="|"), cm_files, invert = TRUE)]
...
qc_files = list.files(path = data_dir, pattern="qc_*")
  ...
  ## Remove new samples- BT1873 and BT1857
  qc_files<- qc_files[grep(paste(c("BT1873", "BT1857"), collapse="|"), qc_files, invert = TRUE)]
