...
ggsave("UMAP_clustering_Res0.6.jpg", path=inferCNV_fig_folder, width = 8, height = 6, dpi = 300)
...
newSamples_tmp<- seurat_obj$seurat_clusters
newSamples<- paste0("cluster", newSamples_tmp)
