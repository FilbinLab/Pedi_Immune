...
working_dir<- paste0(base_dir, "Dropbox (Partners HealthCare)/FilbinLab/data_analysis/Projects/Immune",
                     "/Preprocessing/inferCNV/WithNewSamples/MismatchCells/Cluster2Cluster4Only")
...
## "Sample names" here are actually cluster IDs
load(paste0(input_dir, "cm_list.Robj"))
samples = readRDS("../analysis/inferCNV/seurat/Cluster2Cluster4_samples.rds")
