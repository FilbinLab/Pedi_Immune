...
```{r load-data}
load("../../analysis/midlineHistoneWT_cm_list.Robj")
samples = readRDS("../../analysis/midlineHistoneWT_samples.rds")
tumor_stat = readRDS("../../analysis/inferCNV/seurat/midlineHistoneWT_call_tumor.rds")
