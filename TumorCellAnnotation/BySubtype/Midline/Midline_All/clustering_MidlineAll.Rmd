...
working_dir<- paste0(base_dir, "Dropbox (Partners HealthCare)/FilbinLab/data_analysis/Projects/Immune/Midline_All")
...
```{r load-data}
load("../analysis/midline_cm_list.Robj")
samples = readRDS("../analysis/midline_samples.rds")
tumor_stat = readRDS("../analysis/inferCNV/seurat/midline_call_tumor.rds")
