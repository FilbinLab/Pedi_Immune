...
tumor_stat = readRDS("../analysis/inferCNV/seurat/midlineHistoneMut_cluster6CellsNormal_call_tumor.rds")
samples = readRDS("../analysis/midlineHistoneMut_samples.rds")
genes_to_keep = readRDS(paste0(nmf_folder, "top_10000_ode_cluster6CellsNormal.rds"))
...
```{r}
fname = paste0(nmf_folder, "nmf_raw_data_cluster6CellsNormal.Robj")
...
load(paste0(nmf_folder, "nmf_obj_list_cluster6CellsNormal.Robj"))
load(paste0(nmf_folder, "nmf_gene_list_cluster6CellsNormal.Robj"))
...
pheatmap(nmf_factor_cor, color = hm_colors(100), 
         ...
         filename = paste0(nmf_fig_folder, "nmf_factors_pairwise_cor_cluster6CellsNormal.png"),
         width = 12, height = 8)

## Dendrogram of hierarchical clustering 
jpeg(filename=paste0(nmf_fig_folder, "nmf_factors_hc_cluster6CellsNormal.png"), width = 1200, height = 800)
...
save(nmf_raw_data, file=paste0("analysis/nmf/", "nmf_raw_data_cluster6CellsNormal.Robj"))
```
...
nmf_meta_programs[["OPC-like_Variable"]]<- colnames(nmf_factor_cor)[c(1:3)]
nmf_meta_programs[["AC-like"]]<- colnames(nmf_factor_cor)[4:10]
#nmf_meta_programs[["NMF3"]]<- colnames(nmf_factor_cor)[11:13]
nmf_meta_programs[["MES1"]]<- colnames(nmf_factor_cor)[16:19]
nmf_meta_programs[["Cycling"]]<- colnames(nmf_factor_cor)[20:27]
#nmf_meta_programs[["NMF6"]]<- colnames(nmf_factor_cor)[28:35]
#nmf_meta_programs[["NMF7"]]<- colnames(nmf_factor_cor)[32:35]
...
write.table(tmp4, paste0(seurat_analysis_folder,
                         "ScoreNMFProgramsUsingPreviousNMF_", NameOfMetaprogramList, "_padj.txt"))
```
