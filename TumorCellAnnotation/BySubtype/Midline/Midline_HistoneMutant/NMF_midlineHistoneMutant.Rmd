...
saveRDS(genes_to_keep, file=paste0(nmf_folder, "top_10000_ode.rds"))
...
save(rank_list, file=paste0(nmf_folder, "nmf_rank_list.Robj"))
```
...
for (current_sample in names(rank_list)){
  message(paste0("Current sample: ", current_sample, "; Starting time: ", Sys.time(), "\n"))
  nmf_obj_list[[current_sample]] = nmf(cm_sample[[current_sample]], rank=rank_list[[current_sample]], 
                                       nrun=nrun_single, seed=123456)
  message(paste0("Ending time: ", Sys.time(), "\n"))
}
save(nmf_obj_list, file=paste0(nmf_folder, "nmf_obj_list.Robj"))
...
save(nmf_gene_list, file=paste0(nmf_folder, "nmf_gene_list.Robj"))
```
