...
working_dir<- paste0(base_dir, "Dropbox (Partners HealthCare)/FilbinLab/data_analysis/Projects/Immune/Hemispheric")
...
ggsave(paste0(seurat_fig_folder, "PreviousMetaprograms_NoBT1478.png"))
```
