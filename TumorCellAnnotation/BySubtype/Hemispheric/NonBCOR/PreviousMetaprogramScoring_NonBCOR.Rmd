...
hemispheric_programs<- readRDS(paste0(nmf_analysis_folder,
...
ggsave(paste0(seurat_fig_folder, "PreviousMetaprograms.png"), width=7, height=7)
```

## second highest program for cluster 5 (potentially cycling OC)
```{r}
c5<- seurat_obj@meta.data[seurat_obj@meta.data$seurat_clusters=="5",]
```
