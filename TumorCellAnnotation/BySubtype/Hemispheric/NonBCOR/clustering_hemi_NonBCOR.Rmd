...
working_dir<- paste0(base_dir, "Dropbox (Partners HealthCare)/FilbinLab/data_analysis/Projects/Immune/Hemispheric/NonBCOR/")
...
```{r load-data}
load("../../analysis/hemiNonBCOR_cm_list.Robj")
samples = readRDS("../../analysis/hemiNonBCOR_samples.rds")
tumor_stat = readRDS("../../analysis/inferCNV/seurat/hemiNonBCOR_call_tumor.rds")

cm_list<-hemiNonBCOR_cm_list
...
ggsave("UMAP_sample_theta3.jpg", path=seurat_fig_folder, width=10, height=8)
...
write.table(tmp4, paste0(seurat_analysis_folder,
                        "ScoreSeuratCluster_UsingPreviousNMF_padj.txt"))
