...
working_dir<- paste0(base_dir, "Dropbox (Partners HealthCare)/FilbinLab/data_analysis/Projects/Immune/", 
                     "TumorCellAnnotation/BySubtype/Hemispheric/HistoneWT/WithNewSample/")
...
analysis_dir<- "analysis/Projection/"
figure_dir<- "figures/Projection/"
...
ggsave(paste0(figure_dir, "Predictions_fromG34RVProjection.png"), width=8, height=7)
```
```{r}
## save seurat with predictions
save(wt_seurat_obj, file=paste0(analysis_dir, "wt_seurat_obj.Robj"))
