...
```{r load-data}
input_dir<- "../../../Preprocessing/SplitBySubtype/WithNewSamples/analysis/"
load(paste0(input_dir, "hemiHistoneWT_cm_list.Robj"))
samples = readRDS(paste0(input_dir,"hemiHistoneWT_samples.rds"))
tumor_stat = readRDS(paste0(input_dir,"hemiHistoneWT_call_tumor.rds"))
