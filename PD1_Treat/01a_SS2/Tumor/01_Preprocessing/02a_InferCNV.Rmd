...
write.table(cm, file = paste0(inferCNV_analysis_folder, "counts.matrix"), sep = "\t", quote = FALSE, 
            row.names = TRUE, col.names = TRUE)

## Write tab deliminated cell annotations
write.table(malig_status, file = paste0(inferCNV_analysis_folder, "cellAnnotations.txt"), sep = "\t", quote = FALSE, 
            row.names = TRUE, col.names = FALSE)
```

## Run inferCNV
```{r run_inferCNV}
infercnv_obj = CreateInfercnvObject(raw_counts_matrix=paste0(inferCNV_analysis_folder, "counts.matrix"),
                                    annotations_file=paste0(inferCNV_analysis_folder, "cellAnnotations.txt"),
                                    delim="\t",
...
infercnv_obj = infercnv::run(infercnv_obj,
                             ...
                             out_dir=paste0(inferCNV_analysis_folder, "out_dir"),  # dir is auto-created for storing outputs
...
observations = read.table(paste0(inferCNV_analysis_folder, "out_dir/infercnv.observations.txt"), header = TRUE, sep = " ")

## Normalized gene expressions of predicted normal cells
references = read.table(paste0(inferCNV_analysis_folder, "out_dir/infercnv.references.txt"), header = TRUE, sep = " ")
