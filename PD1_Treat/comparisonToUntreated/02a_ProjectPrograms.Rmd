...
gbm_samples<- unique(c(ss2_seurat$ss_cd4$sample))
...
## Project
ss2_seurat$ss_cd4<- my_project_seurat(cd4_ref,ss2_seurat$ss_cd4, reference_annotation = "NMF_rank8_annot_mergedByunion_reAnnot")
ss2_seurat$ss_cd8<- my_project_seurat(cd8_ref,ss2_seurat$ss_cd8, reference_annotation = "NMF_rank8_annot_mergedByunion_reAnnot")
ss2_seurat$ss_myeloid<- my_project_seurat(myeloid_ref,ss2_seurat$ss_myeloid, reference_annotation = "NMF_rank6_annotByAdult10X")
...
ggsave(paste0(figure_dir_use, "SS2_Sankey_ChangeInAnnotation_Original.v.Projected_noGBMInRef.png"), width=6, height=12)
```
...
```{r}
## SS2
ss2_seurat$ss_cd4<- my_project_seurat(full_cd4_seurat,ss2_seurat$ss_cd4, reference_annotation = "NMF_rank8_annot_mergedByunion_reAnnot")
ss2_seurat$ss_cd8<- my_project_seurat(full_cd8_seurat,ss2_seurat$ss_cd8, reference_annotation = "NMF_rank8_annot_mergedByunion_reAnnot")
ss2_seurat$ss_myeloid<- my_project_seurat(full_myeloid_seurat,ss2_seurat$ss_myeloid, reference_annotation = "NMF_rank6_annotByAdult10X")

## 10x
tenx_seurat$tenx_cd4<- my_project_seurat(full_cd4_seurat,tenx_seurat$tenx_cd4, reference_annotation = "NMF_rank8_annot_mergedByunion_reAnnot")
tenx_seurat$tenx_cd8<- my_project_seurat(full_cd8_seurat,tenx_seurat$tenx_cd8, reference_annotation = "NMF_rank8_annot_mergedByunion_reAnnot")
tenx_seurat$tenx_myeloid<- my_project_seurat(full_myeloid_seurat,tenx_seurat$tenx_myeloid, reference_annotation = "NMF_rank6_annotByAdult10X")
...
cowplot::plot_grid(plotlist=all_plots, ncol=1)
ggsave(paste0(figure_dir_use, "SS2_Sankey_ChangeInAnnotation_Original.v.Projected.png"), width=6, height=12)
```
...
all_plots<- lapply(gsub("tenx_", "", names(tenx_seurat)), function(x){
  ...
  tmp$sample<- factor(tmp$sample, levels=sample_order[sample_order %in% tmp$sample])
  my_barchart_programProp(tmp, coloring_variable = "Program_projected", colors=immune_colors, wrapping_variable = "Treatment")+
    ggtitle(x)+
    theme(axis.text.x = element_text(angle=45, hjust=1))+xlab("")
})
cowplot::plot_grid(plotlist=all_plots, ncol=3)
ggsave(paste0(figure_dir_use, "SS2.TenX_Barchart_PredictedProgram.png"), width=18, height=5)
```
