...
working_dir<- paste0(base_dir, 
                     "Dropbox (Partners HealthCare)/FilbinLab/data_analysis/Projects/Immune/Hemispheric/")
...
load("../analysis/hemi_cm_list.Robj")
tumor_stat = readRDS("../analysis/inferCNV/seurat/hemi_call_tumor.rds")
samples<- readRDS("../analysis/hemi_samples.rds")
