...
## OPTIONAL, plot a dendrogram of hierarchical clustering result for target sample
```{r Plot_dendrogram}
...
## it clusters somewhat with with mg/od across all 4 clusters
## All clusters will be considered malignant- i.e., not taking into account CNV when trying to determine malignancy
## assign the "normal" clusters in BT1478 to be a cluster that does not exist
## Thus all cells in all other clusters will not be considered normal
