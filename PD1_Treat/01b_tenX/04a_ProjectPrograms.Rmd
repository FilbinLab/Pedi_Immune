...
## While waiting on further BT2080 t cell sequencing: remove few BT2080 t cells (confounder, makes plots look weird)
```{r}
remove_BT2080Tcell<- TRUE
if(remove_BT2080Tcell){
  figure_dir<- paste0(figure_dir, "removeBT2080Tcells/")
  if(!dir.exists(figure_dir)){dir.create(figure_dir)}
  tenx_seurat$cd4<- subset(tenx_seurat$cd4, sample!="BT2080")
  tenx_seurat$cd8<- subset(tenx_seurat$cd8, sample!="BT2080")
}
