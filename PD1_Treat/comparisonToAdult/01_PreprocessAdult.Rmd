...
pd1_seurat$broad_annot<- ifelse(pd1_seurat$integrated_snn_res.0.1 %in% tcell_clusters, "Tcell",ifelse(pd1_seurat$integrated_snn_res.0.1 %in% myeloid_clusters, "Myeloid", "Other"))

## plot to show annots
DimPlot(pd1_seurat, group.by="integrated_snn_res.0.1") + DimPlot(pd1_seurat, group.by = "broad_annot", label=TRUE)
