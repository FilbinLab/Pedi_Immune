...
working_dir<- paste0(base_dir, "Dropbox (Partners HealthCare)/FilbinLab/data_analysis/Projects/Immune/PD1_Treat/")
...
ggplot(data=qc_raw_data, aes(x=sample, y=gene, fill=sample)) + 
  ...
  theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 28),
        ...
        legend.title = element_text(face = "bold", size = 24))
ggsave("total_genes.jpg", path=qc_fig_dir, width = 6, height = 8, units = "in")
...
ggplot(data=qc_raw_data, aes(x=sample, y=hk, fill=sample)) + 
  ...
  theme(plot.title = element_text(hjust = 0.5, face = "bold", size = 28),
        ...
        axis.text.y = element_text(size = 24),
        legend.title = element_text(face = "bold", size = 24))
ggsave("hk.jpg", path=qc_fig_dir, width = 6, height = 8, units = "in")
```
...
ggsave("num_cells_pass_qc.jpeg", path=qc_fig_dir, width=4, height=8)
...
ggsave("percentage_cells_pass_qc.jpeg", path=qc_fig_dir, width=8, height=3)
```
