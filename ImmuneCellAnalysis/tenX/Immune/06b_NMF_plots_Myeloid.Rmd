...
ggsave(paste0(figure_dir, "UMAP_byAnnotProgram_ranks", paste(ranks, collapse = "."), ".png"), 
...
ggsave(paste0(figure_dir, "DotPlot_expectedMarkers", paste(ranks, collapse = "."),"_withSubsets.png"), width=14, height=4*length(ranks))
```
