...
analysis_dir<- paste0(working_dir, "/analysis/correlate_deNovo10X_fullCohort/Tcelsl/")
...
## Tcell
  ...
  mean_ss2<- row_means (log2(cm_list_ss2$raw_data + 1))
...
```{r}
analysis_dir_use<- paste0(analysis_dir, "Tcells/scoreTenX/")
figure_dir_use<- paste0(figure_dir, "Tcells/scoreTenX/")
...
```{r}
analysis_dir_use<- paste0(analysis_dir, "Tcells/scoreSS2/")
figure_dir_use<- paste0(figure_dir, "Tcells/scoreSS2/")
for(i in c(analysis_dir_use, figure_dir_use)){if(!dir.exists(i)){dir.create(i)}}
