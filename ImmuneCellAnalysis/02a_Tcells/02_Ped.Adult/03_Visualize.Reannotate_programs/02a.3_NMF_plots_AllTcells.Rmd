...
grouping_variable<- "Age" ## variable to pseudobulk by. "Subtype", "Age", "detailed_annot"
...
ggsave(paste0(figure_dir, "AllTcells_Heatmap_TopNMFgenes_annot_rank", rank,figure_append, ".png"), width=18, height=11)
