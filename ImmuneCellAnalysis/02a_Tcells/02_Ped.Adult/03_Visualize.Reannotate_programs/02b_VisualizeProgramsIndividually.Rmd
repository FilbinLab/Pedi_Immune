...
```{r}
program_name<-paste0("NMF_rank", rank_use, "_annot_mergedBy", sharedBy, "_reAnnot")
subset_to<- c("Cytotoxic", "Predysfunctional", "Inhibitory.Cycling")
remove_cycling<- FALSE
analysis_name<- "Cyto.Predys.InhCyc"
...
colors_use<- c(Inhibitory.Cycling="navy", Predysfunctional="lightsalmon3", Cytotoxic="greenyellow")
