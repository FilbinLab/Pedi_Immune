...
figure_dir<- paste0(working_dir, "/figures/NSCLC/Merge_NSCLC.Glioma/")
...
```{r}
## CD8
  ## Remove Tregs- cd4 specifc
  glioma_markers<- glioma_markers[glioma_markers$cluster!= "Treg",]
  ...
  nsclc_top_markers<- nsclc_markers %>% group_by(Cluster) %>% top_n(n=100, wt=F) %>% as.data.frame()
