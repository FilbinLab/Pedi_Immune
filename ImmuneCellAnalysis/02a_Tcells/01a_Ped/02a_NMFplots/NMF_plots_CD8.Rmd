...
ggsave(paste0(figure_dir, "CD8_Heatmap_TopNMFgenes_annot_rank", rank,figure_append, ".png"), width=14, height=11)
...
filename<- ifelse(removeGBM,"Breakdown_SubtypeByProgram_noGBM", "Breakdown_SubtypeByProgram" )
...
cd8_seurat_tmp<- subset(cd8_seurat, NiceSubtype== "Hemispheric-HistoneWT")
df<- as.data.frame(table(cd8_seurat_tmp$tmp, cd8_seurat_tmp$sample))
