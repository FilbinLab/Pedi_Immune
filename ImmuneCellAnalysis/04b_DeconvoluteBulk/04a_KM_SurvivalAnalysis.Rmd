...
for(cohort in names(surv_res_list)){
  ...
  p<-arrange_ggsurvplots(all_plots, ncol=3, nrow=ceiling(length(all_plots)/3))
  ggsave(plot=p, paste0(figure_dir_use, "CD4_SurvRes_allGenesets.png"), width=9, height=9)
}
```
...
for(cohort in names(surv_res_list)){
  ...
  p<-arrange_ggsurvplots(all_plots, ncol=3, nrow=ceiling(length(all_plots)/3))
  ggsave(plot=p, paste0(figure_dir_use, "Myeloid_SurvRes_allGenesets.png"), width=9, height=9)
}
```
