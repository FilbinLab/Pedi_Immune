...
allSamples_diagnosis<- RunCoxWrapper(geneSet_groups = ToControlFor, AllMeta= finalMeta_allCellTypes$cd8, mySubset="AllSamples", 
                                     controlFor=FALSE, 
                                     exportName = paste0("CD8_univariate_variables_", analysis_name), exportCsv=FALSE, resultsFolder = analysis_dir)
...
allSamples_diagnosis<- RunCoxWrapper(genesets_test, finalMeta_allCellTypes$cd8, mySubset=analysis_name,
                                     ...
                                     exportName=paste0("CD8_ControlFor.", paste(ToBeControlled, collapse = ".")), 
...
allSamples_diagnosis<- RunCoxWrapper(genesets_test, finalMeta_allCellTypes$cd4, mySubset=analysis_name,
                                     controlFor=ToBeControlled,
                                     exportName=paste0("CD4_ControlFor.", paste(ToBeControlled, collapse = ".")), 
                                     exportCsv = TRUE, resultsFolder = analysis_dir)
...
allSamples_diagnosis<- RunCoxWrapper(genesets_test, finalMeta_allCellTypes$myeloid, mySubset=analysis_name,
                                     controlFor=ToBeControlled,
                                     exportName=paste0("Myeloid_ControlFor.", paste(ToBeControlled, collapse = ".")), 
                                     exportCsv = TRUE, resultsFolder = analysis_dir)
...
multi_files<-list.files(analysis_dir, pattern=paste0("ControlFor.", paste(ToBeControlled, collapse=".")))
...
## cycle through rest of cox (multivariate), adding to univariate df
  for (i in multi_files){
    ...
    df2<- df[df$Variable %in% paste0(genesets_test, "High"),]
...
write.csv(AllCox,paste0(analysis_dir, "allCoxResults_ControlFor.", paste(ToBeControlled, collapse="."),"_", analysis_name, ".csv"))
```

## Plot results
```{r}
df<- read.csv(paste0(analysis_dir, "allCoxResults_ControlFor.", paste(ToBeControlled, collapse="."),"_", analysis_name, ".csv"))
...
ggsave(paste0(figure_dir, "allCoxResults_ControlFor.", paste(ToBeControlled, collapse="."),"_", analysis_name, ".png"), width=10, height=4)
```
