...
cell_assignemnts<-readRDS(paste0("../../02a_Tcells/01a_Ped/NMF/analysis/DoubletID/", integration, "/", cohort,
...
unclearNMF<- "3" ## 2 for pedOnly noInt, 5 for pedOnly_nomuv63 noInt, 2 for pedOnly_nomuv63 with Int
