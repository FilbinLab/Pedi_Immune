...
sigLRs_nLR<- sigLRs_plot %>% group_by(interaction_id) %>% summarise(nLRs=n()) %>% as.data.frame()
...
majorCells1<- unique(sigLRs_plot$sender[sigLRs_plot$sender_major==majorCellType1])
majorCells2<- unique(sigLRs_plot$sender[sigLRs_plot$sender_major==majorCellType2])
...
ggsave(paste0(figure_dir_use, "HeatmapByTotalLR_Norm", norm_method,"_",majorCellType1,".", majorCellType2, ".png"),
       width=6, height=4)
