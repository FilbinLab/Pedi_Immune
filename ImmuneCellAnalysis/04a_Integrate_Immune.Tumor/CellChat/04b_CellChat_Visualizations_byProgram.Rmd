...
majorCellType2<- c("CD4", "CD8")
norm_method<- "byCellBySample"
...
ggsave(paste0(figure_dir_use, "Sankey_ByTotalLR_Norm", norm_method,"_",
              paste(majorCellType1, collapse="."),".",
              paste(majorCellType2, collapse="."), ".pdf"),
       device="pdf",
       width=8, height=16)
