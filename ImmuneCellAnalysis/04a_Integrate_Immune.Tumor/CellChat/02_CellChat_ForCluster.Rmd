...
seurat_dir<- paste0(working_dir, "analysis/CellChat/")
seurat_obj_name<- "seurat_list_bySample.Rds"
annotColumn<- "detailed_annotForCellChat"
full_analysis_name<- "test"
comparisons_file<- "analysis/CellChat/all_comparisons.txt"
...
save(all_cellChat_interact, file=paste0(analysis_dir, "/all_cellChat_interact_", 
                                       full_analysis_name, ".Robj"))    
```
