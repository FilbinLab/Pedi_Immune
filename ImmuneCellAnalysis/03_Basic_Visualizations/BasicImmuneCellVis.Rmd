...
DimPlot(seurat_plot, group.by = "plotting", label=TRUE, label.size = 5) %>% umap_theme()
ggsave(paste0(figure_dir, "CD4CD8.BcellDCMonocyte_NoCD4.CD8.png"), width=6, height=5.5)
...
ggsave(paste0(figure_dir, "TCellMyeloid_Sample.png"), width=6, height=6.5)
...
seurat_plot<- subset(adult_tcell, detailed_annot_withCycling != "Unclear")
seurat_plot$plotting<- seurat_plot$detailed_annot_withCycling
DimPlot(seurat_plot, group.by = "plotting",label=TRUE, label.size = 5) %>% umap_theme(immune_colors)
ggsave(paste0(figure_dir, "Adult_TCellMajorCellTypes_WithCycling.png"), width=6, height=5.5)
