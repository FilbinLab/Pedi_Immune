...
figure_dir<- paste0(figure_dir_tmp, cohort, "/", paste0("AdultWithMUV.", adult_withMUV), "/")
analysis_dir<- paste0(analysis_dir_tmp, cohort, "/", paste0("AdultWithMUV.", adult_withMUV), "/")
...
DimPlot(seurat_obj, label=TRUE)+NoLegend()
ggsave(paste0(figure_dir, "UMAP_ByCluster_res0.8", figure_append, ".png"), width=6, height=6)
```
