...
## Plot numeric overlaps with T cells (to show that myeloid "shared" are less similar than T cell "shared")
  ...
  ggsave(paste0(figure_dir, "Overlap_sharedPedAdult_Tcell.Myeloid.pdf"), device="pdf", width=5, height=3)
```
...
## Plot breakdown by subtype
  ...
  ggsave(paste0(figure_dir, "SubtypeBreakdown_byMerged.RegeneratedPrograms.png"), width=8, height=5)
