...
if(use_harmony_forVis=="_harmony"){
  figure_dir_tmp<- paste0(figure_dir, "Harmony/"); if(!dir.exists(figure_dir)){dir.create(figure_dir)}
  }else{figure_dir_tmp<- figure_dir}

myeloid_seurat<-readRDS(paste0("../../01_Preprocessing/02_Counts_Preprocess/analysis/detailed_annotation/",integration, "/",
                               cohort, "/myeloid_seurat_noDC.B.Rds", use_harmony_forVis, ".Rds"))
rank_use<-6
...
ggsave(paste0(figure_dir, "GO_NMFrank", rank, "_10xAnnotated.png"), width=24, height=18)
```
