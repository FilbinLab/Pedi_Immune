...
```{r NMF, eval = F}
estim.r<- readRDS(paste0(analysis_dir, "estimR_rank4-7.Rds"))
rank <- 4:7
...
#saveRDS(myeloid_seurat, file=paste0("../../../CompareToAdult/Myeloid/analysis/Merge_AssessIntegration/",
                           # cohort, "/adult_WithMUV.", adult_withMUV, "/myeloid_seurat_Ped.AdultGBM.IDHMut_merged.Rds"))
```
...
## pedOnly_nomuv63
  ...
  names(nmf_programs)<-c("Monocytes",  "Hypoxic_TAM", "NMF3", "Microglia","IFN_TAM", "Inflammatory")
